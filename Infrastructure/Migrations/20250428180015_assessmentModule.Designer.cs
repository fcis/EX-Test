...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250428180015_assessmentModule")]
    partial class assessmentModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.AssessmentItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("AssignedDepartmentId")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("assessment_item", (string)null);
                });

            modelBuilder.Entity("Core.Entities.AssessmentItemCheckList", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("AssessmentItemId")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("assessment_item_checklist", (string)null);
                });

            modelBuilder.Entity("Core.Entities.AssessmentItemDocument", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("assessment_item_document", (string)null);
                });
            ...
            modelBuilder.Entity("Core.Entities.AssessmentItem", b =>
                {
                    b.HasOne("Core.Entities.Assessment", "Assessment")
                        .WithMany("AssessmentItems")
                        .HasForeignKey("AssessmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Entities.OrganizationDepartments", "AssignedDepartment")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Entities.AssessmentItemCheckList", b =>
                {
                    b.HasOne("Core.Entities.AssessmentItem", "AssessmentItem")
                        .WithMany("CheckListItems")
                        .HasForeignKey("AssessmentItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Entities.ClauseCheckList", "CheckList")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Entities.AssessmentItemDocument", b =>
                {
                    ...
                    b.HasOne("Core.Entities.OrganizationDepartments", "Department")
                        .WithMany()
